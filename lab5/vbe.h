...
////functions and definitions for test_controller()

/* definition of a info struct for vbe_get_conf */

typedef struct {			//attributes taken from page 12 of vbe 2.0 standard
...
/* function that gets the controller info */
